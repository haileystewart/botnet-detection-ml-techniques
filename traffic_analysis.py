...
pcap_file = 'C:/Users/hailey/botnet-detection-ml-techniques/src/phase1/botnet_traffic.pcap'
...
def parse_pcap(file):
    ...
    for packet in packets:
        ...
        if IP in packet and (TCP in packet or UDP in packet):
            # Convert timestamp to float to avoid Decimal errors
            ...
            # Extract time in readable format (using timezone-aware datetime)
